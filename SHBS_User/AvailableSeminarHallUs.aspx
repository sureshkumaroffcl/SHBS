<%@ Page Title="" Language="C#" MasterPageFile="~/SHBS/SHBS_User/SHBS_User.Master" AutoEventWireup="true" CodeBehind="AvailableSeminarHallUs.aspx.cs" Inherits="SeminarHallBookingSystem.SHBS.SHBS_User.AvailableSeminarHallUs" %>
...
<!--app-content open-->
    ...
    <div class="page-header">
        <ol class="breadcrumb">
            <!-- breadcrumb -->
            <li class="breadcrumb-item"><a href="#"><i class="  fe fe-grid hor-icon mr-2"></i>Available Seminar Hall</a></li>
